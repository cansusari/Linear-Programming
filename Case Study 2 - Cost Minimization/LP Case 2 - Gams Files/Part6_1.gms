...
Equations
newobj minimize total amount of high calorie
cost total cost
...
highcalorie3(j) coal type limit of mine 3 for high calorie
highcalorie5(j) coal type limit of mine 5 for high calorie
highcalorie9(j) coal type limit of mine 9 for high calorie
lowcalorie12(j) coal type limit of mine 12 for low calorie
lowcalorie13(j) coal type limit of mine 13 for low calorie
lowcalorie14(j) coal type limit of mine 14 for low calorie ;

newobj.. zn =e= sum((i,j), y(i,j));
cost.. sum((i,j), c(i,j)*(x(i,j)+y(i,j))) =l= 106222448.771559;
...
highcalorie3(j).. y('3',j)=e=0;
highcalorie5(j).. y('5',j)=e=0;
highcalorie9(j).. y('9',j)=e=0;
lowcalorie12(j).. x('12',j)=e=0;
lowcalorie13(j).. x('13',j)=e=0;
lowcalorie14(j).. x('14',j)=e=0;
...
rhsrng all
$offecho
solve case2 using lp minimizing zn ;
