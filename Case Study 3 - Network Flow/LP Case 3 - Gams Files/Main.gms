...
cor6
inv(i) inventory
demand1 demand of computer
demand2 demand of monitor
...
cost.. z =e= sum((i,j), (q(i)*x(i,j))+ (p(i)*y(i,j))+(f(i,j)*t(i,j)))-sum(i,p(i)*y(i,'0'))-sum(i,p(i)*y(i,'5'));
...
rhsrng all
$offecho
solve case1 using lp minimizing z ;
